 ...
 */
final class Version20251209181241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_site_rank ADD CONSTRAINT FK_B303D8F8D60322AC FOREIGN KEY (role_id) REFERENCES `rank` (id)');
